...
KeilMisc\Obj\OEM_CYPRESS.OBJ:Code\Oem\OEM_CYPRESS.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\OEM_CYPRESS.C $(CDirectives)
	move Code\Oem\OEM_CYPRESS.OBJ KeilMisc\Obj
	move Code\Oem\OEM_CYPRESS.LST KeilMisc\Lst

KeilMisc\Obj\OEM_UCSI_CYP_CCG4.OBJ:Code\Oem\OEM_UCSI_CYP_CCG4.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\OEM_UCSI_CYP_CCG4.C $(CDirectives)
	move Code\Oem\OEM_UCSI_CYP_CCG4.OBJ KeilMisc\Obj
	move Code\Oem\OEM_UCSI_CYP_CCG4.LST KeilMisc\Lst

KeilMisc\Obj\OEM_AOU.OBJ:Code\Oem\OEM_AOU.C $(COREInclude) $(OEMInclude) $(CHIPInclude)
	$(CC) Code\Oem\OEM_AOU.C $(CDirectives)
	move Code\Oem\OEM_AOU.OBJ KeilMisc\Obj
	move Code\Oem\OEM_AOU.LST KeilMisc\Lst
#------------------------------------------------------------------
