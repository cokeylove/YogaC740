...
IBYTE 		Timer2msCnt						_at_ 0x5E;//72JERRY076: Optimize ucsi function to handle OPM,EC notify OS every 2S by Q_20.
IBYTE 		Timer4msCnt					_at_ 0x5F;//72JERRY076: Optimize ucsi function to handle OPM,EC notify OS every 2S by Q_20.
									    //Reserved 0x60 ~ 0x64
...
XBYTE	bios_check						    _at_ 0xF4;//hang check
					                    //Reserved 0xF3~ 0xF8
