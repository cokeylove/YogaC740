...
ECReg	PWM1LHE		    _at_ 0x1853;    // PWM0 LED Dimming enable register   //HEGANGS042:Modify the led behavior follow new spec
ECReg	PWM1LCR1		_at_ 0x1854;    // PWM0 LED Dimming control register1  
ECReg	PWM1LCR2		_at_ 0x1855;    // PWM0 LED Dimming control register2 
...
//-----------------------------------------------------------------------------
//72JERRY083:Change MMIO to mailbox for accessing UCSI registers.
ECReg	BRAMBK0[16]            _at_ 0x2200;	// 128 bytes bram
ECReg   UCSI_CCI[4]            _at_ 0x2210;
ECReg   UCSI_MSG_IN[16]		   _at_ 0x2214;
ECReg   UCSI_MSG_OUT[16]       _at_ 0x2224;
ECReg   UCSI_CONTROL[8]        _at_ 0x2234;
ECReg   UCSI_VERSION[2]        _at_ 0x223C;
ECReg   UCSI_RESERVED[2]       _at_ 0x223E;
ECReg   UCSI_WRITEIN_CMD[1]    _at_ 0x2250;
ECReg   UCSI_READOUT_CMD[1]    _at_ 0x2251;
//72JERRY083:Change MMIO to mailbox for accessing UCSI registers.
